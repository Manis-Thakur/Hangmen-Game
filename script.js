...
const gueesedText = document.querySelector(".guesses b");
const gameModel = document.querySelector(".game-model");
const playAgain = document.querySelector(".play-again");

let currentWord, correctWord, wrongGuesses;
const maxGuesses = 6;

const resetGame = () => {
    correctWord = [];
    wrongGuesses = 0;
    hangmanimage.src = `hangman-${wrongGuesses}.svg`;
    gueesedText.innerText = `${wrongGuesses} / ${maxGuesses}`;
